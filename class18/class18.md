...
This can affect all ages but is most severe for those under 1 year of
age.
...
> (1946), the switch to the newer aP vaccine (of 1996), the COVID years
> (2020)?
...
There were high case numbers in the pre-1940s, then the introduction of
the first wP vaccine in 1946 lowered the case numbers and then the case
numbers got even lower with the introduction of the second aP vaccine in
1996. However in the mid-2000s, the case numbers increased due to
circulating myths regarding vaccines and more people lacking the booster
update shots but the case numbers lowered in 2020 due to quarantine and
lockdown mandates which prevented transmission of the whooping cough.
...
They make their data available vis JSON format returning API. We can
